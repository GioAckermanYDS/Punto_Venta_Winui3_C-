...
namespace AlmacenApp.Views
{
    public sealed partial class AlmacenPage : Page
    {
        ...
        private List<Categoria> ListaCategoriasOriginal = new();
       ...
       // public event Action? ViewCategoriasCerrada;
        ...
        private void FiltroCategoriaTextBox_TextChanged(object sender, TextChangedEventArgs e)
        {
            var filtro = FiltroCategoriaTextBox.Text.Trim().ToLower();

            if (string.IsNullOrWhiteSpace(filtro))
            {
                // Restaurar lista original
                ListaCategorias.Clear();
                foreach (var categoria in ListaCategoriasOriginal)
                    ListaCategorias.Add(categoria);
            }
            else
            {
                var filtradas = ListaCategoriasOriginal
        ...
        private async Task ProcesarYCargarCategoriasAsync()
        {
            try
            {
                ...
                ListaCategoriasOriginal = ListaCategorias.ToList();
